		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Prática Model",
									"targetURL": "#mentoriafiorikapraticamodel1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mentoriafiorikapraticamodel1-display": {
								"semanticObject": "mentoriafiorikapraticamodel1",
								"action": "display",
								"description": "App Prática Model",
								"title": "App Prática Model",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mentoria.fiori.ka.praticamodel1",
									"url": sap.ui.require.toUrl("mentoria/fiori/ka/praticamodel1")
								}
							}
						}
					}
